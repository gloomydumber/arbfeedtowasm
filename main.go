...
func main() {
	...
	l2MsgData := utils.DecodeL2Message(msg.Message.Message.L2msg)
	...
	if err != nil {
		...
		utils.PrintTransactionsLength(txs)
		utils.PrintTransaction(txs[0])

		lastTimestamp := uint64(1728980884) // 1728980884

		txs = utils.AppendStartTransaction(
			txs,
			msg.Message.Message.Header.L1BaseFee,
